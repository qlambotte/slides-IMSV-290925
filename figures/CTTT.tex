...
\tkzLabelSegment[line width=2pt, above, pos=0](A,B){\Large$\tan(\alpha)$}
   ...
   \tkzLabelPoint[below=4pt](S2){\Large$-\dfrac{\sqrt{2}}{2}$}
   \tkzLabelPoint[below=4pt](S3){\Large$-\dfrac{\sqrt{3}}{2}$}
   \tkzDefPoints{1/0.57735026919/S1,1/1.73205080757/S2,1/-0.57735026919/S3,1/-1.73205080757/S4,
   1/1/S5,1/-1/S6}
   \tkzDrawPoints[shape=cross,size=12](S1,S2,S3,S4,S5,S6)
   \tkzLabelPoint[right=4pt](S1){\Large$\dfrac{\sqrt{3}}{3}$}
   \tkzLabelPoint[right=4pt](S2){\Large$\sqrt{3}$}
    \tkzLabelPoint[right=4pt](S3){\Large$-\dfrac{\sqrt{3}}{3}$}
    \tkzLabelPoint[right=4pt](S4){\Large$-\sqrt{3}$}
     \tkzLabelPoint[right=4pt](S5){\Large$1$}
     \tkzLabelPoint[right=4pt](S6){\Large$-1$}
